function main()
    ...
    darwin.dtw.write_file("release/MaktubOne.c", onefile)
    ...
    darwin.dtw.write_file("release/Maktub.h", only_declare)
    ...
    only_definition = '#include "Maktub.h"\n' .. only_definition

    only_definition = lincense .. only_definition

    darwin.dtw.write_file("release/Maktub.c", only_definition)

    os.execute("zip -r release/Maktub.zip dependencies src build")
